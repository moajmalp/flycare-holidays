    ...
    <div className="flex flex-col pb-0 pt-0">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="pt-12">
                  <div className="relative aspect-[4/5] rounded-[40px] overflow-hidden mb-4 shadow-2xl transition-transform duration-500 hover:scale-105">
                    <Image src="/images/kashmir.png" alt="Traveler" fill className="object-cover" />
                  </div>
                </div>
                <div>
                  <div className="relative aspect-[4/5] rounded-[40px] overflow-hidden mb-4 shadow-2xl transition-transform duration-500 hover:scale-105">
                    <Image src="/images/vietnam.png" alt="Traveler" fill className="object-cover" />
                  </div>
      ...
      <section className="py-32 px-4">
        <div className="max-w-7xl mx-auto w-full relative h-[450px] rounded-[56px] overflow-hidden group">
          <Image src="/images/kerala.png" alt="CTA BG" fill className="object-cover group-hover:scale-105 transition-transform duration-1000" />
